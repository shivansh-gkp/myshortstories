...
<p align="left" style="font-family:Courier; color:white; font-size: 20px;">
   <h4>This website is all about learning ....</h4>
   <h4>By making this website i am trying to learn the basics of web-designing and development</h4>
   <h4>using php, sql, css, javascript, html etc.</h4>
   <h4>This website will be a messaging website .</h4>
</p>
</div>
</body>
</html>